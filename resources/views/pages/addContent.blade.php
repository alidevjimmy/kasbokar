        ...
        <div class="row">
            <div class="col-md-12 mt-2">
                <div class="profile-div border-radius-def p-4">
                    <h5 class="old-font"><span class="black-50">محتوای جدید</h5>
                    <br>
                    @auth
                        <div class="col-md-12 mt-2" style="margin: auto">
                            <form method="POST" action="{{ route('contents.store' , ['type' => 'content']) }}" enctype="multipart/form-data">
                                @csrf
                    ...
                    @else
                        <div class="alert alert-danger">برای ایجاد محنوای جدید باید <a href="{{ route('login' , ['redirect' => route('contents.add')]) }}">وارد شوید</a></div>
                        <div class="container mt-2 align-items-center">
                            <div class="row">
                                <p>برای ایجاد محنوای جدید باید <a href="{{ route('login' , ['redirect' => route('contents.add')]) }}">وارد شوید</a></p>
                            </div>
                        </div>
                    @endauth
                </div>
