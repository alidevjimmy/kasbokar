        ...
        <div class="col-md-12 profile-div">
            <div class="col-md-12 div-scrolable">
                <ul class="profile-ul">
                    ...
                    <li><a href="{{ route('profile' , ['user' => $user->id , 'page' => 'myAnswers']) }}" class="{{ $page == 'myAnswers' ? 'profile-page' : null }}">پاسخ های ارسال شده</a></li>
                    <li><a href="{{ route('profile' , ['user' => $user->id , 'page' => 'myReplays']) }}" class="{{ $page == 'myReplays' ? 'profile-page' : null }}">پاسخ های دریافتی</a></li>
                </ul>
            </div>
            <div class="col-md-12 mt-5">
                ...
                <h6><a href="">جواب شما به {{ $ans->content->title }}</a></h6>
                <p>
                    <div class="col-md-12 box-readed mt-2 mb-2">
                        {{ $ans->answer }   }
                    </div>
